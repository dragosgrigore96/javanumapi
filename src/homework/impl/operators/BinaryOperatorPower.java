...
public final class BinaryOperatorPower implements IBinaryOperator<Number> {
 ...
 */
@Override
public IOperand calculate(final Number leftOperand,
final Number rightOperand) {
ImplOperand result = new ImplOperand();
Number res = Math.pow(leftOperand.doubleValue(), rightOperand.doubleValue());
